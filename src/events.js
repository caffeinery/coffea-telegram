...
export default function events (bot, dispatch) {
  ...
  bot.on('game', forward('game'))
  bot.on('pinned_message', forward('pinned_message'))
  bot.on('migrate_from_chat_id', forward('migrate_from_chat_id'))
  bot.on('migrate_to_chat_id', forward('migrate_to_chat_id'))
  bot.on('channel_chat_created', forward('channel_chat_created'))
  bot.on('supergroup_chat_created', forward('supergroup_chat_created'))
  bot.on('successful_payment', forward('successful_payment'))
  bot.on('invoice', forward('invoice'))
  ...
  bot.on('edited_channel_post', forward('edited_channel_post'))
  ...
  bot.on('polling_error', (err) => dispatch(error({ err })))
  bot.on('webhook_error', (err) => dispatch(error({ err })))
